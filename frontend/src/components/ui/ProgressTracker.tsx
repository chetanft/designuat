...
export default function ProgressTracker({ comparisonId, onComplete, onError }: ProgressTrackerProps) {
  ...
  const [steps, setSteps] = useState<ProgressStep[]>([
    ...
    },
    {
      ...
      description: 'Analyzing differences and generating report',
      icon: ChartBarIcon,
      status: 'pending',
      progress: 0,
      estimatedTime: 10
  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Comparison Progress</h3>
          <p className="text-sm text-gray-600">
            {currentProgress?.message || 'Initializing comparison...'}
          </p>
        </div>
